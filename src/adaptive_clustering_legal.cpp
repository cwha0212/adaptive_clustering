...
int main(int argc, char **argv) {
  ...
  /*** Subscribers ***/
  ros::NodeHandle nh;
  ros::Subscriber point_cloud_sub = nh.subscribe<sensor_msgs::PointCloud2>("/legal", 1, pointCloudCallback);
  ...
  marker_array_pub_ = private_nh.advertise<visualization_msgs::MarkerArray>("legal_kickboard", 100);
